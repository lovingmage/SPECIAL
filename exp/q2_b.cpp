...
int main(int argc, char** argv) {
    ...
    // Q3 - Baseline 1
    // Sim SeqAcc of Loan data [sized 42338]
    SecureRelation relationA(1, 42338);
    init_relation(relationA, 1, 42338);
    ...
    // compact size to DP upper bounds
    filtered_relationA.compact(21);
